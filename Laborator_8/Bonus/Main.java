...
//
//            PlaylistAlbums playlistAlbum1 = new PlaylistAlbums(1, 255);
//            PlaylistAlbums playlistAlbum2 = new PlaylistAlbums(1, 345);
//            PlaylistAlbums playlistAlbum3 = new PlaylistAlbums(1, 567);
//            PlaylistAlbums playlistAlbum4 = new PlaylistAlbums(2, 1064);
//            PlaylistAlbums playlistAlbum5 = new PlaylistAlbums(2, 555);
//            PlaylistAlbums playlistAlbum6 = new PlaylistAlbums(3, 456);
//            PlaylistAlbums playlistAlbum7 = new PlaylistAlbums(3, 780);
//            PlaylistAlbums playlistAlbum8 = new PlaylistAlbums(4, 255);
//            PlaylistAlbums playlistAlbum9 = new PlaylistAlbums(4, 255);
//
...
//
//            System.out.println("All playlists albums are :");
...
//            }
            ...
            System.out.println("Playlist generat: ");
            int counter_lista = 1;
